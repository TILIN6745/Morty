...
**/
    ...
    if ((isMedia && quoted.mtype === 'imageMessage') && htextos) {
      ...
      await conn.relayMessage(m.chat, {extendedTextMessage: {text: `${masss}\n${htextos}\n`, ...{contextInfo: {mentionedJid: users, externalAdReply: {thumbnail: imagen1, sourceUrl: 'https://www.instagram.com/tilin.ff.23?igsh=ZmJneGw5YWphb3h2'}}}}}, {});
    }
  }
};
handler.command = /^(hidetag|notificar|n|noti|noty|notify|aviso)$/i;
handler.group = true;
handler.admin = true;
