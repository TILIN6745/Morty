...
description = official[0][0] == String(contact[0]) ? 'Solo temas de tilin bot' : official[1][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[2][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : official[3][0] == String(contact[0]) ? lenguajeGB.smsContacto4() : desc === '' ? lenguajeGB.smsContacto5() : desc
correo = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/tilin.ff.23' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/tilin.ff.23' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/tilin.ff.23' : mail === '' ? lenguajeGB.smsContacto6() : mail
lugar = official[0][0] == String(contact[0]) ? 'Tilin' : official[1][0] == String(contact[0]) ? 'Tilin' : official[2][0] == String(contact[0]) ? 'Tilin' : official[3][0] == String(contact[0]) ? 'Tilin' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'Tilin' : official[1][0] == String(contact[0]) ? 'Tilin' : official[2][0] == String(contact[0]) ? 'Tilin' : official[3][0] == String(contact[0]) ? 'Tilin' : md 

lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.instagram.com/tilin.ff.23' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'https://www.instagram.com/tilin.ff.23' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
await conn.sendFile(m.chat, pp, 'lp.jpg', cat, fkontak, false, { contextInfo: {externalAdReply :{ mediaUrl: null, mediaType: 1, description: null, title: gt, body: '𝗧𝗜𝗟𝗜𝗡-𝗕𝗢𝗧', previewType: 0, thumbnail: gataImg, sourceUrl: accountsgb.getRandom()}}})
